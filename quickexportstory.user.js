...
// @updateURL    https://raw.githubusercontent.com/aerodevxp/dreamgen_xp_scripts/refs/heads/main/quickexportstory.user.js
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    function checkAndRunScript() {
        if (window.location.href.startsWith(targetUrlStart)) {
            initExportFunctionality(); // Run the main script logic
        }
    }
    ...
    function initExportFunctionality() {
        ...
        if (document.querySelector('.export-button-initialized')) return;
        ...
        button.classList.add('export-button-initialized'); // Mark as initialized
